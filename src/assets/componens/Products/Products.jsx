...
if(isLoading){
  ...
  return (
    <>
<form className=" md:w-[60%] mx-auto py-8">   
    <div className="relative">
        <input type="search" id="default-search" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500 dark:bg-green-700 dark:border-green-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Search..." required />
    </div>
</form>

        <div className="py-6 mx-auto md:w-[90%]">
    ...
    <div className="px-2 pb-4 ">
        ...
        <NavLink>
          <button  >
                        {isLoading ? <i className="fa-solid fa-heart text-red-400 text-3xl"></i> : <i className="fa-solid fa-heart text-red-600 text-3xl"></i>}
